...
algs_to_drill = {'BA', 'BC', 'BD', 'BE', 'BF', 'BG', 'BH', 'BJ', 'BK', 'BL', 'BM', 'BO', 'BP', 'BS', 'BT', 'BV', 'BW',
                 'BZ'}
number = 0
...
while True:
    ...
    if algs_to_drill.intersection(no_cycle_break_corner_memo) or no_cycle_break_corner_memo.intersection(algs_to_drill):
        # print(algs_to_drill.intersection(no_cycle_break_corner_memo))
        print(scramble)
        # quit()
